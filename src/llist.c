...
llist test_func(void)
{
    int ret = 0;
    
    llist test = NULL;
    test = llist_create (trivial_comperator, trivial_equal);
    ret = llist_add_node(test, "abcdef", ADD_NODE_FRONT);
    ret = llist_add_node(test, "hellosadfasdfasdfsdfasd", ADD_NODE_FRONT);
    ret = llist_add_node(test, "bye", ADD_NODE_FRONT);
    ret = llist_add_node(test, "ayo", ADD_NODE_FRONT);
    if (ret != 0)
    {
        printf("fail : %d\n",ret);
    }
...
//     test1 = test_func();
//     
//     ret = llist_sort(test1, SORT_LIST_ASCENDING);
//     printf("ret:%d %d\n",ret,llist_size(test1));
//     print_llist(test1);
//     ret = llist_find_node(test1, "bye", &retptr);
//     printf("ret:: %d\n",ret);
//     ret = llist_find_node(test1, "bye2", &retptr);
//     printf("ret:: %d\n",ret);
// }
